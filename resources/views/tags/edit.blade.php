                ...
                <div class="p-6 text-gray-900 w-3/5">
                    <form action="{{route('tags.update', $tag->id)}}" method="post">
                        ...
                        <div class="mb-4">
                            ...
                            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="tag" type="text" name="tag" value="{{ old('nom', $tag->nom) }}" required>
                        </div>
